...
routes.use("/customer", require("./routes/customer_management_routes"))
routes.use("/communication", require("./routes/communication_management_routes"))
...
routes.use("/payment", require("./routes/payment_management_routes"))
routes.use("/payment_method", require("./routes/payment_method_routes"))
routes.use("/prepay", require("./routes/prepay_balance_routes"))
routes.use("/product_offering_qualification", require("./routes/product_offering_qualification_routes"))
...
routes.use("/roles_and_permission_hub", require("./routes/roles_and_permissions_hub_routes"))
